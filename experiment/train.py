...
class Network(object):
    ...
    def val(self):
        ...
        if self.show_dice_coeff:
            ...
            wandb.log({'Val/pixAcc': pixAcc, 'Val/mIoU': mIoU, 'Val/loss': loss, 'Val/dice_coeff':mdice_coeff, "Epoch": self.epoch})
        else:
    ...
    def test(self):
        ...
        if not isinstance(target, list):
            ...
            wandb.log({'Test/loss': self.test_loss_meter.mloss, 'Test/pixAcc': pixAcc, 'Test/mIoU': mIoU})
        else:
